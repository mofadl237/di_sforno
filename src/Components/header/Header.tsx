...
const Header = () => {
  ...
  const logo = publicSettings?.branding?.logo;
      ...
      >
        ...
        >
          <motion.span
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-sm md:h-14 md:w-14"
          >
